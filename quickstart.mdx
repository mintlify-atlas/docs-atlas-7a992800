...
<CardGroup cols={2}>
  <Card title="Models Reference" icon="cube" href="/api/models/ctx">
    Learn about all available models and their capabilities
  </Card>
  
  <Card title="Actions Reference" icon="bolt" href="/api/runtime/messages">
    Explore all actions you can dispatch
  </Card>
  
  <Card title="Environment Trait" icon="circle-nodes" href="/api/runtime/env">
    Implement the Env trait for your platform
  </Card>
  
  <Card title="Types Reference" icon="shapes" href="/api/types/addon">
